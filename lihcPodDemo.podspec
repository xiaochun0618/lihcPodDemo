...
Pod::Spec.new do |s|
  s.name             = 'lihcPodDemo'
  s.version          = '0.1.0'
  s.summary          = 'A short description of lihcPodDemo.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lihc/lihcPodDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lihc' => 'lihc@fenbi.com' }
  s.source           = { :git => 'https://github.com/lihc/lihcPodDemo.git', :tag => s.version.to_s }
